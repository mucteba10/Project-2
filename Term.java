...
public class Term implements Comparable<Term> {
    ...
    private static class PrefixOrder implements Comparator<Term> {
        ...
        public int compare(Term v, Term w) {
            int rv = Math.min(r, v.query.length());
            int rw = Math.min(r, w.query.length());

            String vPrefix = v.query.substring(0, rv);
            String wPrefix = w.query.substring(0, rw);
